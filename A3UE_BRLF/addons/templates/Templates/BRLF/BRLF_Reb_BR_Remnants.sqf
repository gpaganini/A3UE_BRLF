...
["name", "BRLF Remnants"] call _fnc_saveToTemplate;
...
private _vehiclesLightUnarmed = ["BRAF_LMV_EB", "BRAF_AM21_GLO", "BRAF_AM21_Opened","BRAF_AM11_Unarmed", "I_G_Offroad_01_F", "I_C_Offroad_02_unarmed_F"];
...
private _initialRebelEquipment = [
    ...
    "V_Chestrig_oli","V_Chestrig_rgr","V_TacChestrig_grn_F","V_TacChestrig_oli_F","V_TacChestrig_cbr_F","V_PlateCarrier1_rgr_noflag_F","V_CarrierRigKBT_01_Olive_F","V_CarrierRigKBT_01_light_Olive_F","CUP_V_I_Carrier_Belt", "CUP_V_I_RACS_Carrier_Rig_2", "CUP_V_I_RACS_Carrier_Rig_wdl_2",
